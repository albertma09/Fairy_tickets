...
==  Introducción
Os presentamos la memoria del segundo proyecto del curso 2023-2024 de 2o de Desarrollo de Aplicaciones Web del instituto Nicolau Copèrnic. Este proyecto consta del desarrollo de una página web de gestión de eventos y de la creación y posterior uso de APIs Restful. 

En este documento presentaremos el equipo de trabajo, las especificaciones y requerimientos del proyecto, el manual de instalación de la aplicación, el manual de las APIs y diversas consideraciones para el futuro.

=== Miembros del equipo
* Albert Mateos, estudiante de 2o de DAW en instituto Nicolau Copèrnic.
* Aitor Lopera, estudiante de 2o de DAW en instituto Nicolau Copèrnic.
...
Tanto para el diseño de los mockups de las diferentes vistas como para la guía de estilos hemos usado FIGMA, encontraréis sendos enlaces en cada uno de los apartados.
