...
@section('content')
    ...
    <form class="default-form" action="{{ route('sessions.store') }}" method ="POST">
        ...
        <div class="input-unit">
            ...
            <input type="datetime-local" id="datetime" name="sessionDatetime" value="{{ old('sessionDatetime') }}" required />
        ...
        <!-- Entradas nominales -->
        <div class="row-unit">
            <input type="checkbox" id="named_tickets" name="named_tickets" {{ old('named_tickets') ? 'checked' : '' }} />
