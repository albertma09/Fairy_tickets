...
@section('content')
    ...
    {{-- <div> --}}
        <div class="content-options-promotor">
            <div class="add-event"><a class="button button-brand" href="{{ route('events.create') }}">Añadir evento</a></div>
        ...
        <div class="promotor-container">
            @foreach ($events as $event)
                <div class="event-card">
                    <div class="img">
                        <img src="{{ $event->mainBgImg }}" alt="imagen principal del evento" loading="lazy">
                    </div>
